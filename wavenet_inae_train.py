...
usage: wavenet_inae_train.py [options]
...
from autoencoders.wavenet_ae_model import INAE, NewINAE, INAE1
...
def build_model():
    ...
    if hparams.name == 'inae':
        ...
        model = NewINAE(wavenet=wavenet,c_in=39,hid=64, frame_rate = hparams.frame_rate)
    return model
