...
infer_dir=exp/0321vqvae_0/infer/
result_dir=exp/0321vqvae_0/result/
lan=english
...
#do
/share/mini1/sw/std/python/anaconda3-2019.07/v3.7/envs/zerospeech2020_1/bin/zerospeech2020-evaluate 2017-track1 -j10 ${infer_dir} -l $lan  -o ${result_dir}${lan}.json
