...
def mfcc(y):
    _mfcc = librosa.feature.mfcc(y,sr=hparams.sample_rate,n_fft=hparams.fft_size,hop_length=get_hop_size(),n_mels=hparams.num_mels,n_mfcc=hparams.n_mfcc)
    
    _mfcc_delta = librosa.feature.delta(_mfcc)
    _mfcc_delta2 = librosa.feature.delta(_mfcc,order=2)
    feature = np.concatenate([_mfcc,_mfcc_delta,_mfcc_delta2],axis=0)   
    return feature
