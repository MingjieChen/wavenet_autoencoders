...
if __name__ == "__main__":
    args = docopt(__doc__)
    #name = args["<name>"]
    scp_dir = args["<scp_dir>"] # default: scp/2017/[train,dev,test]_src_dst.json
    out_dir = args["<out_dir>"] # default: dump/2017/[train_no_dev,dev,test]/
    sp2ind_dir = args['<sp2ind_dir>'] # 2017_speaker2ind.json
